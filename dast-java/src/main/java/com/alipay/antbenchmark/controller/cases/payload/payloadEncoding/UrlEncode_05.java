...
// compose = UrlEncode_05.java
// bind_url = /cmdi/BS00042
// assession information end

@Controller
@RequestMapping(value = "/cmdi")
public class UrlEncode_05 extends HttpServlet {
    private static final Logger log = LoggerFactory.getLogger("UrlEncode_05");
