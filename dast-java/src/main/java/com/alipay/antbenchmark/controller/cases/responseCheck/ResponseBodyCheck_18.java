...
// compose = ResponseBodyCheck_18.java
// bind_url = /sqli/BS00101
// assession information end


@Controller
@RequestMapping(value = "/sqli")
public class ResponseBodyCheck_18 extends HttpServlet {

    private static final Logger log = LoggerFactory.getLogger("ResponseBodyCheck_18");


    @ResponseBody
    @RequestMapping(value = "/BS00101", method = {RequestMethod.GET, RequestMethod.GET})
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        response.setContentType("text/html;charset=UTF-8");
        String param = request.getParameter("BS00101");
        if (param == null) {
            param = "";
        }
        //检测列名注入的能力
