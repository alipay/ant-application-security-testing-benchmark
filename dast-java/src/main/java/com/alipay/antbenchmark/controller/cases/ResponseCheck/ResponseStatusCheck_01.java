...
// compose = ResponseStatusCheck_01.java
// bind_url = /sqli/BS00097
// assession information end


@Controller
@RequestMapping(value = "/sqli")
public class ResponseStatusCheck_01 extends HttpServlet {

    private static final Logger log = LoggerFactory.getLogger("ResponseStatusCheck_01");
