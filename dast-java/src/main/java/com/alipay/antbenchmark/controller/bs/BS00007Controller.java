...
public class BS00007Controller extends HttpServlet {
    private static final Logger log = LoggerFactory.getLogger("BS00007Controller");

    @ResponseBody
    @RequestMapping(value = "/BS00007", method = {RequestMethod.POST, RequestMethod.GET})
