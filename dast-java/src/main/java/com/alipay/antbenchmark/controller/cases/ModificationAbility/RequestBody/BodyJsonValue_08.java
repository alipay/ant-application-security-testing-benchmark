...
// compose = BodyJsonValue_08.java
// bind_url = /sqli/BS00131
// assession information end

@Controller
@RequestMapping(value = "/sqli")
public class BodyJsonValue_08 extends HttpServlet {

    private static final Logger log = LoggerFactory.getLogger("BodyJsonValue_08");
