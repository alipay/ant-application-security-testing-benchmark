...
// compose = ResponseHeaderCheck_05.java
// bind_url = /cors/BS00112
// assession information end


@Controller
@RequestMapping(value = "/cors")
public class ResponseHeaderCheck_05 extends HttpServlet {
    private static final long serialVersionUID = 1L;


    @ResponseBody
    @RequestMapping(value = "/BS00112", method = {RequestMethod.POST, RequestMethod.GET})
