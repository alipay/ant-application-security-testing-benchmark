...
// compose = MethodGet_01.java
// bind_url = /sqli/BS00091
// assession information end


@Controller
@RequestMapping(value = "/sqli")
public class MethodGet_01 extends HttpServlet {

    private static final Logger log = LoggerFactory.getLogger("MethodGet_01");


    @ResponseBody
    @RequestMapping(value = "/BS00091", method = {RequestMethod.GET, RequestMethod.GET})
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        response.setContentType("text/html;charset=UTF-8");
        String param = request.getParameter("BS00091");
        if (param == null) {
            param = "";
        }
        //检测扫描器闭合单引号进行SQL注入的能力
