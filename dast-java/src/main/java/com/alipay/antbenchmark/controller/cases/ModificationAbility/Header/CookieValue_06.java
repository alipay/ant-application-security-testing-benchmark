...
// compose = CookieValue_06.java
// bind_url = /sqli/BS00023
// assession information end


@Controller
@RequestMapping(value = "/sqli")
public class CookieValue_06 extends HttpServlet {
    private static final Logger log = LoggerFactory.getLogger("CookieValue_06");
