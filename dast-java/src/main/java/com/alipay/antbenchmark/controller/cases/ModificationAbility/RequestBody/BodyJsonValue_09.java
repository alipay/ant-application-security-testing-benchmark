...
// compose = BodyJsonValue_09.java
// bind_url = /ssrf/BS00134
// assession information end

@Controller
@RequestMapping(value = "/ssrf")
public class BodyJsonValue_09 extends HttpServlet {

    private static final Logger log = LoggerFactory.getLogger("BodyJsonValue_09");
