...
// compose = SymbolAdd_03.java
// bind_url = /cmdi/BS00092
// assession information end


@Controller
@RequestMapping(value = "/cmdi")
public class SymbolAdd_03 extends HttpServlet {

    private static final Logger log = LoggerFactory.getLogger("SymbolAdd_03");
