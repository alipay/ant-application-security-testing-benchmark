...
// compose = PayloadReplace_05.java
// bind_url = /sqli/BS00151
// assession information end

@Controller
@RequestMapping(value = "/sqli")
public class PayloadReplace_05 extends HttpServlet {
    private static final long serialVersionUID = 1L;


    @ResponseBody
    @RequestMapping(value = "/BS00151", method = {RequestMethod.POST, RequestMethod.GET})
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        response.setContentType("text/html;charset=UTF-8");
        String[] white_list = {"username", "password", "userid"};

        String param = request.getParameter("BS00151");
