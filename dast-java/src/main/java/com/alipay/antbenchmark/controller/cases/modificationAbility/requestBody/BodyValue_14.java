...
// bind_url = /sqli/BS00140
// assession information end

@Controller
@RequestMapping(value = "/sqli")
public class BodyValue_14 extends HttpServlet {

    private static final Logger log = LoggerFactory.getLogger("BodyValue_14");

    @ResponseBody
    @RequestMapping(value = "/BS00140", method = {RequestMethod.POST, RequestMethod.GET})
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        response.setContentType("text/html;charset=UTF-8");
        String param = request.getParameter("BS00140");
        if (param == null) {
            param = "";
        }
        param = param.replace("\\", "\\\\");
