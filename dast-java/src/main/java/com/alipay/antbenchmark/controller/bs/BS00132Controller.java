...
public class BS00132Controller extends HttpServlet {

    private static final Logger log = LoggerFactory.getLogger("BS00132Controller");


    @ResponseBody
    @RequestMapping(value = "/BS00132", method = {RequestMethod.POST, RequestMethod.GET})
