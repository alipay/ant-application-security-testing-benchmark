...
// assession project = 改包能力->请求方法->DELETE请求
// compose = MethodDelete_01.java
// bind_url = /ssrf/BS00085
// assession information end


@Controller
@RequestMapping(value = "/ssrf")
public class MethodDelete_01 extends HttpServlet {
    private static final long serialVersionUID = 1L;


    @ResponseBody
    @RequestMapping(value = "/BS00085", method = {RequestMethod.DELETE})
