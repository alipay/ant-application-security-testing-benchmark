...
// compose = PayloadReplace_02.java
// bind_url = /sqli/BS00066
// assession information end


@Controller
@RequestMapping(value = "/sqli")
public class PayloadReplace_02 extends HttpServlet {
    private static final long serialVersionUID = 1L;


    @ResponseBody
    @RequestMapping(value = "/BS00066", method = {RequestMethod.POST, RequestMethod.GET})
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        response.setContentType("text/html;charset=UTF-8");
        String param = request.getParameter("BS00066");
        if (param == null) {
            param = "";
        }
        String sql = "SELECT  * from USERS where USERNAME='foo' and PASSWORD='bar' limit " + param + "";
        try {
