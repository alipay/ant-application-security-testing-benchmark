...
// compose = SymbolAdd_04.java
// bind_url = /sqli/BS00093
// assession information end


@Controller
@RequestMapping(value = "/sqli")
public class SymbolAdd_04 extends HttpServlet {

    private static final Logger log = LoggerFactory.getLogger("SymbolAdd_04");


    @ResponseBody
    @RequestMapping(value = "/BS00093", method = {RequestMethod.GET, RequestMethod.GET})
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        response.setContentType("text/html;charset=UTF-8");
        String param = request.getParameter("BS00093");
        if (param == null) {
            param = "";
        }
        //过滤两种注释符，检测扫描器将payload加上#的能力
        if (param.contains("--") || param.contains(";\00")) {
