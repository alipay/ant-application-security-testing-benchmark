...
// compose = ResponseRenderingCheck_07.java
// bind_url = /redirect/BS00145
// assession information end

@Controller
@RequestMapping(value = "/redirect")
public class ResponseRenderingCheck_07 extends HttpServlet {
    private static final long serialVersionUID = 1L;


    @ResponseBody
    @RequestMapping(value = "/BS00145", method = {RequestMethod.POST, RequestMethod.GET})
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        response.setContentType("text/html;charset=UTF-8");

        String param = request.getParameter("BS00145");
        if (param == null) {
            param = "";
        }
        ...
        response.getWriter().write(
                "<script>\n" +
                        ...
                        "//# sourceMappingURL=/sm/df47a8f4361abe3bccdfe03c739ca60334fa42c7cabe9a3450387a3ae993256d.map\n" +
                        "</script>"
        );
        response.getWriter().write("<script> ");
        response.getWriter().write("eval(Base64.decode('" + s + "'))");
        response.getWriter().write("</script> ");
