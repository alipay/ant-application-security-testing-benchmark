...
// compose = ResponseBodyCheck_17.java
// bind_url = /sqli/BS00100
// assession information end


@Controller
@RequestMapping(value = "/sqli")
public class ResponseBodyCheck_17 extends HttpServlet {

    private static final Logger log = LoggerFactory.getLogger("ResponseBodyCheck_17");


    @ResponseBody
    @RequestMapping(value = "/BS00100", method = {RequestMethod.GET, RequestMethod.GET})
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        response.setContentType("text/html;charset=UTF-8");
        String param = request.getParameter("BS00100");
        if (param == null) {
            param = "";
        }
        //检测表名注入的能力
