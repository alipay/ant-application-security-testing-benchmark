...
// compose = ResponseTimeCheck_02.java
// bind_url = /sqli/BS00099
// assession information end


@Controller
@RequestMapping(value = "/sqli")
public class ResponseTimeCheck_02 extends HttpServlet {

    private static final Logger log = LoggerFactory.getLogger("ResponseTimeCheck_02");
