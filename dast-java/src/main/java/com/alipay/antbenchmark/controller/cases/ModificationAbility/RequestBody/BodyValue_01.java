...
// compose = BodyValue_01.java
// bind_url = /sqli/BS00009
// assession information end


@Controller
@RequestMapping(value = "/sqli")
public class BodyValue_01 extends HttpServlet {
    private static final Logger log = LoggerFactory.getLogger("BodyValue_01.java");

    @ResponseBody
    @RequestMapping(value = "/BS00009", method = {RequestMethod.POST})
