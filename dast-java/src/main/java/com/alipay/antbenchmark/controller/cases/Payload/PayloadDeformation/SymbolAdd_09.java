...
// compose = SymbolAdd_09.java
// bind_url = /cmdi/BS00123
// assession information end


@Controller
@RequestMapping(value = "/cmdi")
public class SymbolAdd_09 extends HttpServlet {

    private static final Logger log = LoggerFactory.getLogger("SymbolAdd_09");
