...
// compose = ResponseBodyCheck_01.java
// bind_url = /xss/BS00011
// assession information end


@Controller
@RequestMapping(value = "/xss")
public class ResponseBodyCheck_01 extends HttpServlet {
    private static final long serialVersionUID = 1L;

    @ResponseBody
    @RequestMapping(value = "/BS00011", method = {RequestMethod.GET})
