...
// compose = SymbolAdd_06.java
// bind_url = /sqli/BS00118
// assession information end


@Controller
@RequestMapping(value = "/sqli")
public class SymbolAdd_06 extends HttpServlet {

    private static final Logger log = LoggerFactory.getLogger("SymbolAdd_06");

    @ResponseBody
    @RequestMapping(value = "/BS00118", method = {RequestMethod.GET, RequestMethod.GET})
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        // some code
        response.setContentType("text/html;charset=UTF-8");
        String param = request.getParameter("BS00118");
        if (param == null) {
            param = "";
        }
        //检测扫描器闭合双引号进行SQL注入的能力
