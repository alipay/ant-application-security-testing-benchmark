...
import com.iast.astbenchmark.config.wapper.StringProcessHttpServletRequest;
...
public class MyFilter implements Filter {
        ...
        private  final Set<String> FILTER_PATHS = Collections.unmodifiableSet(new HashSet<>(
                Arrays.asList("/case0041")));
        @Override
