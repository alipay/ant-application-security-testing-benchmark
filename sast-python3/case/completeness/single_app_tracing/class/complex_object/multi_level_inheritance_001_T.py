...
# level = 2+
# bind_url = completeness/single_app_tracing/class/complex_object/multi_level_inheritance_001_T
# evaluation information end

import os

def multi_level_inheritance_001_T(taint_src):
    class C:
...
if __name__ == "__main__":
    ...
    multi_level_inheritance_001_T(taint_src)