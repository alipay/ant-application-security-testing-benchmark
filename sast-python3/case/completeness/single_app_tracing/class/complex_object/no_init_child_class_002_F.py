...
# level = 2+
# bind_url = completeness/single_app_tracing/class/complex_object/no_init_child_class_002_F
# evaluation information end

import os

def no_init_child_class_002_F(taint_src):
    class Parent:
...
if __name__ == "__main__":
    ...
    no_init_child_class_002_F(taint_src)