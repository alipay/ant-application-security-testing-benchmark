...
# level = 2
# bind_url = completeness/single_app_tracing/function_call/higher_order_function/higher_order_function_011_F
...
def higher_order_function_011_F(taint_src):
    ...
    # 使用高阶函数处理回调函数
    result = process_callback(to_upper, "_")
    taint_sink(result)
...
if __name__ == "__main__":
    ...
    higher_order_function_011_F(taint_src)
