...
# level = 2
# bind_url = completeness/single_app_tracing/asynchronous_tracing/promise_callback_await/asynchronous_await_008_F
...
async def asynchronous_await_008_F(taint_src):
...
if __name__ == "__main__":
    ...
    asyncio.run(asynchronous_await_008_F(taint_src))
