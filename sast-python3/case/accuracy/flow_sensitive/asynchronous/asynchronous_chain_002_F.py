...
# level = 4
# bind_url = accuracy/flow_sensitive/asynchronous/asynchronous_chain_002_F
# evaluation information end
import os
import asyncio

async def asynchronous_chain_002_F(taint_src):
...
async def main(taint_src):
    await asynchronous_chain_002_F(taint_src)
