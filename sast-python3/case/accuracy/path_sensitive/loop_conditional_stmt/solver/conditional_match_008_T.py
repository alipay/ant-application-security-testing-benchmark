...
# level = 4
# bind_url = accuracy/path_sensitive/loop_conditional_stmt/solver/conditional_match_008_T
# evaluation information end
import os


def conditional_match_008_T(taint_src):
    data = ''
    match 1 + 1:  # 表达式计算为 2
        case 2:    # 匹配成功，执行分支
...
if __name__ == "__main__":
    ...
    conditional_match_008_T(taint_src)
