...
# level = 4+
# bind_url = accuracy/field_sensitive/one_dimensional_collection/numeric_index_state_solver/array_solver_005_T
...
def array_solver_005_T(taint_src):
...
if __name__ == "__main__":
    ...
    array_solver_005_T(taint_src)  # 输出：_（仅第一个字符）
