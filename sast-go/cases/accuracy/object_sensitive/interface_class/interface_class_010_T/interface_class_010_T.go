...
// level = 2
// bind_url = accuracy/object_sensitive/interface_class/interface_class_010_T/interface_class_010_T
...
func interface_class_010_T(__taint_src string) {
...
func main() {
    ...
    interface_class_010_T(__taint_src)
}