...
// level = 2
// bind_url = accuracy/object_sensitive/interface_class/interface_class_007_F/interface_class_007_F
...
func interface_class_007_F(__taint_src string) {
...
func main() {
    ...
    interface_class_007_F(__taint_src)
}