...
// level = 2
// bind_url = completeness/single_app_tracing/interface_class/interface_implementation/struct_injection_interface_001_T/struct_injection_interface_001_T
...
func struct_injection_interface_001_T(__taint_src string) {
	// 创建 IctestImpl 实例
	testSvc := &IctestImpl{}
...
func main() {
	...
	struct_injection_interface_001_T(__taint_src)
}
