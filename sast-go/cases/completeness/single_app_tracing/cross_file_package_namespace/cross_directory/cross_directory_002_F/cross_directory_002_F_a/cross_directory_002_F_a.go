...
//执行跨模块文件时需先cd到sast-go/cases/completeness/single_app_tracing/cross_file_package_namespace/cross_directory/cross_directory_002_F
//再执行go run cross_directory_002_F_a/cross_directory_002_F_a.go
package main
