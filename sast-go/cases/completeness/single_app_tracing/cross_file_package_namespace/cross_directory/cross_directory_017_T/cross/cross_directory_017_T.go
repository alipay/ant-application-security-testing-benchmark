...
func cross_directory_017_T(__taint_src string) {
	cross_init.In_init_after(__taint_src)

	 // 若正确处理，Status的值应该是"1234taint_src_value"
...
func main() {
	...
	cross_directory_017_T(__taint_src)
}
