...
//在执行时先cd到sast-go/cases/completeness/single_app_tracing/cross_file_package_namespace/cross_module/cross_module_004_F/cross_module_004_F_b
//再执行 go run cross_module_004_F_b.go
...
func main() {
    ...
    cross_module_004_F_b(__taint_src)
}