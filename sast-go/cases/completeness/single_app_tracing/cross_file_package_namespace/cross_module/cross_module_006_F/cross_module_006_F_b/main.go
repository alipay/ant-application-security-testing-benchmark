...
// level = 2
// bind_url = completeness/single_app_tracing/cross_file_package_namespace/cross_module/cross_module_006_F/cross_module_006_F_b/main
// evaluation information end

// 先cd sast-go/cases/completeness/single_app_tracing/cross_file_package_namespace/cross_module/cross_module_006_F
// 在执行 go run ./cross_module_006_F_b
package main
import "os/exec"
...
func cross_module_006_F_b(__taint_src string) {
	__taint_sink("this is main2")
}
