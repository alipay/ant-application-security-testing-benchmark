...
//在执行时先cd到sast-go/cases/completeness/single_app_tracing/cross_file_package_namespace/cross_module/cross_module_001_T/cross_module_001_T_b
//再执行 go run cross_module_001_T_b.go
