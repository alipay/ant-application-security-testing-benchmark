...
# level = 4+
# bind_url = accuracy/field_sensitive/one_dimensional_collection/numeric_index_state_solver/array_solver_007_T
# evaluation information end
import os
import array

def array_solver_007_T(taint_src):
...
if __name__ == u"__main__":
    ...
    array_solver_007_T(taint_src)  # 输出：_（仅第一个字符）
