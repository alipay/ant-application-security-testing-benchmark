...
# level = 2+
# bind_url = completeness/single_app_tracing/class/complex_object/inject_data_new_004_F
# evaluation information end

import os

def inject_data_new_004_F(taint_src):
    class Meta(type):
    ...
    obj2 = ComplexObject(u"aaa")
    # 调用 Meta 中注入的方法，并传入 tainted_data
    transformed_data = obj2.data_transform(obj2.tainted_data)
...
if __name__ == u"__main__":
    ...
    inject_data_new_004_F(taint_src)