...
# level = 2
# bind_url = completeness/single_app_tracing/function_call/anonymous_function_closure/anonymous_function_007_F
# evaluation information end

import os

def anonymous_function_007_F(taint_src):
...
if __name__ == u'__main__':
    ...
    anonymous_function_007_F(taint_src)
