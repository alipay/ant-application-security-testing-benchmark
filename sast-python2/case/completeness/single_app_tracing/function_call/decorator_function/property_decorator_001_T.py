...
# level = 2+
# bind_url = completeness/single_app_tracing/function_call/decorator_function/property_decorator_001_T
...
def property_decorator_001_T(taint_src):
    obj = TaintedInput("_")         
...
if __name__ == '__main__':
    ...
    property_decorator_001_T(taint_src)