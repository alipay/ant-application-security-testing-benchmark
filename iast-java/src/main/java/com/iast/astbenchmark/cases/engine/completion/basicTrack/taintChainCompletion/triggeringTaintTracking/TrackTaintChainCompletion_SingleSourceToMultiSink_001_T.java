...
// assession project = IAST引擎能力评估体系(JAVA) -> 完整度 -> 基础跟踪能力 -> 污点链路完整度 -> 触发污点跟踪能力（sink） -> 单污点来源传播至多sink点
// compose = TrackTaintChainCompletion_SingleSourceToMultiSink_001_T.java
// bind_url = /case00109
