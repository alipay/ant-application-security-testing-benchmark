...
// assession project = IAST引擎能力评估体系(JAVA) -> 完整度 -> 基础跟踪能力 -> 污点对象完整度 -> 基本数据类型及其封装类型 -> Integer
// compose = TrackTaintObjectCompletion_Integer_001_T.java
// bind_url = /case0010
// assession information end
public class TrackTaintObjectCompletion_Integer_001_T implements IastTestCaseDescriptor, IastTestCasePayloadProvider {
