...
public class AstTaintCase001 {
     ...
     */
    @GetMapping("case002")
    @CaseTag(caseNo = "aTaintCase002", caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点对象完整度->基本数据类型及其封装类型->char",
        thisMethodTag = "aTaintCase002", thisMethodExpectedResult = true)
     ...
     */
    @GetMapping("case003")
    @CaseTag(caseNo = "aTaintCase003", caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点对象完整度->基本数据类型及其封装类型->byte",
        thisMethodTag = "aTaintCase003", thisMethodExpectedResult = true)
     ...
     */
    @GetMapping("case004")
    @CaseTag(caseNo = "aTaintCase004", caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点对象完整度->基本数据类型及其封装类型->long",
        thisMethodTag = "aTaintCase004", thisMethodExpectedResult = true)
    ...
    @PostMapping("case005")
    @CaseTag(caseNo = "aTaintCase005", caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点对象完整度->集合(集合对象全为污点)->Map元素",
        thisMethodTag = "aTaintCase005", thisMethodExpectedResult = true)
     ...
     */
    @PostMapping("case006")
    @CaseTag(caseNo = "aTaintCase006", caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点对象完整度->集合(集合对象全为污点)->List元素",
        thisMethodTag = "aTaintCase006", thisMethodExpectedResult = true)
    ...
    @CaseTag(caseNo = "aTaintCase007", caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点对象完整度->集合(集合对象全为污点)->Queue元素",
        thisMethodTag = "aTaintCase007", thisMethodExpectedResult = true)
     ...
     */
    @PostMapping("case008")
    @CaseTag(caseNo = "aTaintCase008", caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点对象完整度->集合(集合对象全为污点)->Set元素",
        thisMethodTag = "aTaintCase008", thisMethodExpectedResult = true)
     ...
     */
    @PostMapping("case009")
    @CaseTag(caseNo = "aTaintCase009", caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点对象完整度->基本数据类型及其封装类型->Byte",
        thisMethodTag = "aTaintCase009", thisMethodExpectedResult = true)
    ...
    @CaseTag(caseNo = "aTaintCase0010",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点对象完整度->基本数据类型及其封装类型->Integer",
        thisMethodTag = "aTaintCase0010", thisMethodExpectedResult = true)
    ...
    @CaseTag(caseNo = "aTaintCase0011", caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点对象完整度->基本数据类型及其封装类型->Long",
        thisMethodTag = "aTaintCase0011", thisMethodExpectedResult = true)
    ...
    @CaseTag(caseNo = "aTaintCase0012",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点对象完整度->基本数据类型及其封装类型->Character",
        thisMethodTag = "aTaintCase0012", thisMethodExpectedResult = true)
    ...
    @CaseTag(caseNo = "aTaintCase0013",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点对象完整度->数组(数组对象全为污点)->数组对象String[]",
        thisMethodTag = "aTaintCase0013", thisMethodExpectedResult = true)
    ...
    @CaseTag(caseNo = "aTaintCase0014",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点对象完整度->数组(数组对象全为污点)->数组对象char[]",
        thisMethodTag = "aTaintCase0014", thisMethodExpectedResult = true)
    ...
    @CaseTag(caseNo = "aTaintCase0015",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点对象完整度->数组(数组对象全为污点)->数组对象byte[]",
        thisMethodTag = "aTaintCase0015", thisMethodExpectedResult = true)
    ...
    @CaseTag(caseNo = "aTaintCase0016",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点对象完整度->数组(数组对象全为污点)->单维数组对象的元素",
        thisMethodTag = "aTaintCase0016", thisMethodExpectedResult = true)
    ...
    @CaseTag(caseNo = "aTaintCase00926",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点对象完整度->数组(数组对象全为污点)->多维数组对象的元素",
        thisMethodTag = "aTaintCase00926", thisMethodExpectedResult = true)
    ...
    @CaseTag(caseNo = "aTaintCase00921",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点对象完整度->自定义对象->对象字段->单层字段->10",
        thisMethodTag = "aTaintCase00921_2", thisMethodExpectedResult = true)
    ...
    @CaseTag(caseNo = "aTaintCase00921",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点对象完整度->自定义对象->对象字段->单层字段->10",
        thisMethodTag = "aTaintCase00921_3", thisMethodExpectedResult = true)
    ...
    @CaseTag(caseNo = "aTaintCase00922",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点对象完整度->自定义对象->对象字段->单层字段->100",
        thisMethodTag = "aTaintCase00922", thisMethodExpectedResult = true)
    ...
    @CaseTag(caseNo = "aTaintCase00922",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点对象完整度->自定义对象->对象字段->单层字段->100",
        thisMethodTag = "aTaintCase00922_2", thisMethodExpectedResult = true)
    ...
    @CaseTag(caseNo = "aTaintCase00922",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点对象完整度->自定义对象->对象字段->单层字段->100",
        thisMethodTag = "aTaintCase00922_3", thisMethodExpectedResult = true)
    ...
    @CaseTag(caseNo = "aTaintCase00923",
        ...
        thisMethodTag = "aTaintCase00923", thisMethodExpectedResult = true)
    ...
    @CaseTag(caseNo = "aTaintCase00923",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点对象完整度->自定义对象->对象字段->多层字段->3层",
        thisMethodTag = "aTaintCase00923_3", thisMethodExpectedResult = true)
    ...
    @CaseTag(caseNo = "aTaintCase00924",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点对象完整度->自定义对象->对象字段->多层字段->10层",
        thisMethodTag = "aTaintCase00924", thisMethodExpectedResult = true)
    ...
    @CaseTag(caseNo = "aTaintCase00924",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点对象完整度->自定义对象->对象字段->多层字段->10层",
        thisMethodTag = "aTaintCase00924_2", thisMethodExpectedResult = true)
    ...
    @CaseTag(caseNo = "aTaintCase00924",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点对象完整度->自定义对象->对象字段->多层字段->10层",
        thisMethodTag = "aTaintCase00924_3", thisMethodExpectedResult = true)
    ...
    @CaseTag(caseNo = "aTaintCase00925",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点对象完整度->自定义对象->对象字段->污点为父类字段",
        thisMethodTag = "aTaintCase00925", thisMethodExpectedResult = true)
    ...
    @CaseTag(caseNo = "aTaintCase00925",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点对象完整度->自定义对象->对象字段->污点为父类字段",
        thisMethodTag = "aTaintCase00925_2", thisMethodExpectedResult = true)
