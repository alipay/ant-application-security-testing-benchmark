...
/**
 * Introduction 基本类型int 作为污点对象 Level X Date 2024-05-11
 *
 * @author CC11001100
 */
@RestController
public class TrackTaintObjectCompletion_Int_001_T implements IastTestCaseDescriptor, IastTestCasePayloadProvider  {
     ...
     */
    @GetMapping("case001")
    @IastTestCase(caseNo = "aTaintCase001",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点对象完整度->基本数据类型及其封装类型->int", thisMethodTag = "aTaintCase001",
        hasVul = true)
