...
public class AstTaintCase002 {
    ...
    @CaseTag(caseNo = "aTaintCase0022", caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点链路完整度->特殊链路跟踪能力->三方包方法跟踪",
        thisMethodTag = "aTaintCase0022", thisMethodExpectedResult = true)
    ...
    @CaseTag(caseNo = "aTaintCase0023",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点链路完整度->特殊链路跟踪能力->超长链路追踪->100层",
        thisMethodTag = "aTaintCase0023", thisMethodExpectedResult = true)
    ...
    @CaseTag(caseNo = "aTaintCase00931",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点链路完整度->特殊链路跟踪能力->超长链路追踪->1000层",
        thisMethodTag = "aTaintCase00931", thisMethodExpectedResult = true)
    ...
    @CaseTag(caseNo = "aTaintCase0024", caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点链路完整度->特殊链路跟踪能力->反射调用方法跟踪",
        thisMethodTag = "aTaintCase0024", thisMethodExpectedResult = true)
    ...
    @CaseTag(caseNo = "aTaintCase0025", caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点链路完整度->特殊链路跟踪能力->调用native方法",
        thisMethodTag = "aTaintCase0025", thisMethodExpectedResult = true)
    ...
    @CaseTag(caseNo = "aTaintCase00146",
        ...
        thisMethodTag = "aTaintCase00146", thisMethodExpectedResult = true)
    ...
    @CaseTag(caseNo = "aTaintCase00147",
        ...
        thisMethodTag = "aTaintCase00147", thisMethodExpectedResult = true)
    ...
    @CaseTag(caseNo = "aTaintCase0063",
        ...
        thisMethodTag = "aTaintCase0063", thisMethodExpectedResult = true)
    ...
    @CaseTag(caseNo = "aTaintCase0064",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点链路完整度->污点传播跟踪能力->传播场景->String操作->copyValueOf",
        thisMethodTag = "aTaintCase0064", thisMethodExpectedResult = true)
    ...
    @CaseTag(caseNo = "aTaintCase0065",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点链路完整度->污点传播跟踪能力->传播场景->String操作->format",
        thisMethodTag = "aTaintCase0065", thisMethodExpectedResult = true)
    ...
    @CaseTag(caseNo = "aTaintCase0066",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点链路完整度->污点传播跟踪能力->传播场景->String操作->getBytes",
        thisMethodTag = "aTaintCase0066", thisMethodExpectedResult = true)
    ...
    @CaseTag(caseNo = "aTaintCase0067",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点链路完整度->污点传播跟踪能力->传播场景->String操作->getChars",
        thisMethodTag = "aTaintCase0067", thisMethodExpectedResult = true)
    ...
    @CaseTag(caseNo = "aTaintCase0068",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点链路完整度->污点传播跟踪能力->传播场景->String操作->intern",
        thisMethodTag = "aTaintCase0068", thisMethodExpectedResult = true)
    ...
    @CaseTag(caseNo = "aTaintCase0069",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点链路完整度->污点传播跟踪能力->传播场景->String操作->join",
        thisMethodTag = "aTaintCase0069", thisMethodExpectedResult = true)
    ...
    /**
     * aTaintCase0071 传播场景->String操作->replace ls;-la
     */
    @PostMapping(value = "case0071")
    @CaseTag(caseNo = "aTaintCase0071",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点链路完整度->污点传播跟踪能力->传播场景->String操作->replace",
        thisMethodTag = "aTaintCase0071", thisMethodExpectedResult = true)
    ...
    /**
     * aTaintCase00140 传播场景->String操作->replace alasa
     */
    @PostMapping(value = "case00140")
    @CaseTag(caseNo = "aTaintCase00140",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点链路完整度->污点传播跟踪能力->传播场景->String操作->replaceAll",
        thisMethodTag = "aTaintCase00140", thisMethodExpectedResult = true)
    ...
    @CaseTag(caseNo = "aTaintCase0072",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点链路完整度->污点传播跟踪能力->传播场景->String操作->split",
        thisMethodTag = "aTaintCase0072", thisMethodExpectedResult = true)
    ...
    @CaseTag(caseNo = "aTaintCase0074",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点链路完整度->污点传播跟踪能力->传播场景->String操作->subSequence",
        thisMethodTag = "aTaintCase0074", thisMethodExpectedResult = true)
    ...
    @CaseTag(caseNo = "aTaintCase0075",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点链路完整度->污点传播跟踪能力->传播场景->String操作->substring",
        thisMethodTag = "aTaintCase0075", thisMethodExpectedResult = true)
    ...
    @CaseTag(caseNo = "aTaintCase0076",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点链路完整度->污点传播跟踪能力->传播场景->String操作->toCharArray",
        thisMethodTag = "aTaintCase0076", thisMethodExpectedResult = true)
    ...
    @CaseTag(caseNo = "aTaintCase0077",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点链路完整度->污点传播跟踪能力->传播场景->String操作->toLowerCase",
        thisMethodTag = "aTaintCase0077", thisMethodExpectedResult = true)
    ...
    @CaseTag(caseNo = "aTaintCase0078",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点链路完整度->污点传播跟踪能力->传播场景->String操作->toString",
        thisMethodTag = "aTaintCase0078", thisMethodExpectedResult = true)
    ...
    @CaseTag(caseNo = "aTaintCase0079",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点链路完整度->污点传播跟踪能力->传播场景->String操作->toUpperCase",
        thisMethodTag = "aTaintCase0079", thisMethodExpectedResult = true)
    ...
    @CaseTag(caseNo = "aTaintCase0080",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点链路完整度->污点传播跟踪能力->传播场景->String操作->trim",
        thisMethodTag = "aTaintCase0080", thisMethodExpectedResult = true)
    ...
    @CaseTag(caseNo = "aTaintCase0081",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点链路完整度->污点传播跟踪能力->传播场景->String操作->valueOf",
        thisMethodTag = "aTaintCase0081", thisMethodExpectedResult = true)
    ...
    @CaseTag(caseNo = "aTaintCase0082",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点链路完整度->污点传播跟踪能力->传播场景->StringBuilder操作->构造方法",
        thisMethodTag = "aTaintCase0082", thisMethodExpectedResult = true)
    ...
    @CaseTag(caseNo = "aTaintCase0083",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点链路完整度->污点传播跟踪能力->传播场景->StringBuilder操作->append",
        thisMethodTag = "aTaintCase0083", thisMethodExpectedResult = true)
    ...
    @CaseTag(caseNo = "aTaintCase0085",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点链路完整度->污点传播跟踪能力->传播场景->StringBuilder操作->delete",
        thisMethodTag = "aTaintCase0085", thisMethodExpectedResult = true)
    ...
    @CaseTag(caseNo = "aTaintCase0088",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点链路完整度->污点传播跟踪能力->传播场景->StringBuilder操作->insert",
        thisMethodTag = "aTaintCase0088", thisMethodExpectedResult = true)
    ...
    @CaseTag(caseNo = "aTaintCase0089",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点链路完整度->污点传播跟踪能力->传播场景->StringBuilder操作->replace",
        thisMethodTag = "aTaintCase0089", thisMethodExpectedResult = true)
    ...
    @CaseTag(caseNo = "aTaintCase0093",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点链路完整度->污点传播跟踪能力->传播场景->char[],byte[]操作->copyOf",
        thisMethodTag = "aTaintCase0093", thisMethodExpectedResult = true)
    ...
    /**
     * aTaintCase0095 传播场景-char[],byte[]操作->deepToString //deepToString 的参数是Object[] *使用Byte[]
     */
    @PostMapping(value = "case0095")
    @CaseTag(caseNo = "aTaintCase0095",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点链路完整度->污点传播跟踪能力->传播场景->char[],byte[]操作->deepToString",
        thisMethodTag = "aTaintCase0095", thisMethodExpectedResult = true)
    ...
    @CaseTag(caseNo = "aTaintCase0096",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点链路完整度->污点传播跟踪能力->传播场景->char[],byte[]操作->toString",
        thisMethodTag = "aTaintCase0096", thisMethodExpectedResult = true)
    ...
    @CaseTag(caseNo = "aTaintCase00932",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点链路完整度->污点传播跟踪能力->传播场景->JDK序列化与反序列化",
        thisMethodTag = "aTaintCase00932", thisMethodExpectedResult = true)
    public Map<String, Object> aTaintCase00932(@RequestBody SourceTestObject sourceTestObject)
        throws ClassNotFoundException {
        Map<String, Object> modelMap = new HashMap<>();
        try {
    ...
    @CaseTag(caseNo = "aTaintCase00141",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点链路完整度->污点无害化处理能力(sanitizer)->污点直接赋值为硬编码值",
        thisMethodTag = "aTaintCase00141", thisMethodExpectedResult = false)
    ...
    @CaseTag(caseNo = "aTaintCase00141",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点链路完整度->污点无害化处理能力(sanitizer)->污点直接赋值为硬编码值",
        thisMethodTag = "aTaintCase00141_1", thisMethodExpectedResult = true)
    ...
    @CaseTag(caseNo = "aTaintCase00103",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点链路完整度->污点无害化处理能力(sanitizer)->sanitizer支持区分类型",
        thisMethodTag = "aTaintCase00103_2", thisMethodExpectedResult = true)
    ...
    @CaseTag(caseNo = "aTaintCase00103",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点链路完整度->污点无害化处理能力(sanitizer)->sanitizer支持区分类型",
        thisMethodTag = "aTaintCase00103_1", thisMethodExpectedResult = true)
    ...
    @CaseTag(caseNo = "aTaintCase00103",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点链路完整度->污点无害化处理能力(sanitizer)->sanitizer支持区分类型",
        thisMethodTag = "aTaintCase00103", thisMethodExpectedResult = false)
    ...
    @CaseTag(caseNo = "aTaintCase00104",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点链路完整度->污点无害化处理能力(sanitizer)->触发sink后再执行sanitizer",
        thisMethodTag = "aTaintCase00104", thisMethodExpectedResult = true)
    ...
    @CaseTag(caseNo = "aTaintCase00104",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点链路完整度->污点无害化处理能力(sanitizer)->触发sink后再执行sanitizer",
        thisMethodTag = "aTaintCase00104_1", thisMethodExpectedResult = false)
    ...
    @CaseTag(caseNo = "aTaintCase00104",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点链路完整度->污点无害化处理能力(sanitizer)->触发sink后再执行sanitizer",
        thisMethodTag = "aTaintCase00104_2", thisMethodExpectedResult = true)
    ...
    @CaseTag(caseNo = "aTaintCase00105",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点链路完整度->污点无害化处理能力(sanitizer)->支持自定义unSanitizer(再次污点化)",
        thisMethodTag = "aTaintCase00105_1", thisMethodExpectedResult = false)
    ...
    @CaseTag(caseNo = "aTaintCase00105",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点链路完整度->污点无害化处理能力(sanitizer)->支持自定义unSanitizer(再次污点化)",
        thisMethodTag = "aTaintCase00105_2", thisMethodExpectedResult = true)
    public Map<String, Object> aTaintCase00105_2(@RequestParam String cmd) {
        Map<String, Object> modelMap = new HashMap<>();
        cmd = TaintMethodUtil.sanitizer(cmd);
        cmd = TaintMethodUtil.unSanitizer(cmd);
        TaintMethodUtil.sink(cmd);
        modelMap.put("status", CommonConsts.SUCCESS_STR);
        return modelMap;
    }
    ...
    @CaseTag(caseNo = "aTaintCase00109",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点链路完整度->触发污点跟踪能力（sink）->单污点来源传播至多sink点",
        thisMethodTag = "aTaintCase00109", thisMethodExpectedResult = true)
    ...
    @CaseTag(caseNo = "aTaintCase00110",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点链路完整度->触发污点跟踪能力（sink）->多污点来源传播至单sink点",
        thisMethodTag = "aTaintCase00110", thisMethodExpectedResult = true)
    ...
    @CaseTag(caseNo = "aTaintCase00112",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点链路完整度->触发污点跟踪能力（sink）->无污点传播过程，污点直接传入sink",
        thisMethodTag = "aTaintCase00112", thisMethodExpectedResult = true)
