...
// compose = TrackTaintChainCompletion_StringConstructorStringBuilder_001_T.java
// bind_url = /case00149
// assession information end
public class TrackTaintChainCompletion_StringConstructorStringBuilder_001_T
    implements IastTestCaseDescriptor, IastTestCasePayloadProvider {

    @PostMapping(value = "case00149")
    @IastTestCase(caseNo = "aTaintCase00149",
        caseFullName = "IAST引擎能力评估体系(JAVA)->完整度->基础跟踪能力->污点链路完整度->污点传播跟踪能力->传播场景->String操作->构造方法->String(StringBuilder builder)",
        thisMethodTag = "aTaintCase00149", hasVul = true)
