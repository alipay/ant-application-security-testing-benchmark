...
// assession project = IAST引擎能力评估体系(JAVA) -> 完整度 -> 基础跟踪能力 -> 污点链路完整度 -> 污点传播跟踪能力 -> 传播场景 -> StringBuilder操作 -> delete
// compose = TrackTaintChainCompletion_StringBuilderDelete_001_T.java
// bind_url = /case0085
// assession information end
public class TrackTaintChainCompletion_StringBuilderDelete_001_T
