...
// level = 2
// bind_url = completeness/single_app_tracing/datatype/array/array_filter_001_T
// date = 2025-12-16 09:24:29
// evaluation information end
const { execSync } = require("child_process");

function array_filter_001_T(__taint_src) {
  // 场景特点：使用filter方法过滤后保留污点元素
