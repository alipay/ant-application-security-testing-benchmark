...
// level = 2
// bind_url = completeness/single_app_tracing/datatype/array/array_slice_001_T
// date = 2025-12-16 09:24:29
// evaluation information end
const { execSync } = require("child_process");

function array_slice_001_T(__taint_src) {
  // 场景特点：使用slice方法截取包含污点的数组片段
