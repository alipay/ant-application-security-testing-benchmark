...
// level = 2
// bind_url = completeness/single_app_tracing/datatype/collections/set_delete_002_F
// date = 2025-12-16 10:58:42
// evaluation information end
const { execSync } = require('child_process');

function set_delete_002_F(__taint_src) {
  // 场景特点：使用delete方法删除污点元素后访问安全元素
