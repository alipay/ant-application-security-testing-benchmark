...
// compose = Base_Short_002_T.java
// bind_url = completeness/base/object/javaNative/Base_Short_002_T/{cmd}
// assession information end

@RestController()
@RequestMapping("completeness/base/object/javaNative")
public class Base_Short_002_T {
    @PostMapping("Base_Short_002_T/{cmd}")
