...
/**
 * Introduction 污点链路样本中的表达式-StringBuilder+toUpperCase
 * Level X
 * Date 2024-05-09
 */
// assession information start
// real vulnerability = true
// assession project = 完整度->基础跟踪能力->污点链路完整度->特殊场景->无源码函数调用->StringBuilder+toUpperCase
// compose = CallExpression_NoSourceCode_Native_033_T.java
// bind_url = completeness/base/chain/special/CallExpression_NoSourceCode_Native_033_T
