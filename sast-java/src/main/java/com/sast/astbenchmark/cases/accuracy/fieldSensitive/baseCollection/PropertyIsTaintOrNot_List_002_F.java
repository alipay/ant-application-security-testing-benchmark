...
// bind_url = accuracy/fieldSensitive/PropertyIsTaintOrNot_List_002_F
// assession information end

@RestController()
@RequestMapping("accuracy/fieldSensitive")
public class PropertyIsTaintOrNot_List_002_F {
    @PostMapping(value = "PropertyIsTaintOrNot_List_002_F")
    public Map<String, Object> testcase(@RequestParam String cmd) {
        ...
        try {
            ...
            Runtime.getRuntime().exec(data.get(0));
