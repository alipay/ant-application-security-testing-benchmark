...
// bind_url = accuracy/fieldSensitive/objectField/IntraproceduralAlias_001_T
// assession information end
@RestController
@RequestMapping("accuracy/fieldSensitive/objectField")
public class IntraproceduralAlias_001_T {
    @PostMapping(value = "IntraproceduralAlias_001_T")
