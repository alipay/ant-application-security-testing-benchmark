...
// compose = Statement_Assignment_001_T.java
// bind_url = completeness/base/chain/astTaint/Statement_Assignment_001_T/{cmd}
// assession information end
@RestController()
@RequestMapping("completeness/base/chain/astTaint")
public class Statement_Assignment_001_T {
    @PostMapping("Statement_Assignment_001_T/{cmd}")
