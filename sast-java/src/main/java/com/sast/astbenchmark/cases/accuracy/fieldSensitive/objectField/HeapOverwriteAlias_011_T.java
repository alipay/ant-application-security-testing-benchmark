...
// bind_url = accuracy/fieldSensitive/objectField/HeapOverwriteAlias_011_T
// assession information end
@RestController
@RequestMapping("accuracy/fieldSensitive/objectField")
public class HeapOverwriteAlias_011_T {
    @PostMapping(value = "HeapOverwriteAlias_011_T")
