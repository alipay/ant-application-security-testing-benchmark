...
// bind_url = completeness/base/chain/special/nosource/CallExpression_NoSourceCode_Native_Collection_008_F
// assession information end

@RestController()
@RequestMapping("completeness/base/chain/special/nosource")
public class CallExpression_NoSourceCode_Native_Collection_008_F {
    @PostMapping("CallExpression_NoSourceCode_Native_Collection_008_F")
