...
// bind_url = completeness/base/object/javaNative/Base_VarargArrayAccess_002_F
// assession information end

@RestController()
@RequestMapping("completeness/base/object/javaNative")
public class Base_VarargArrayAccess_002_F {
    @PostMapping("Base_VarargArrayAccess_002_F")
    public Map<String, Object> testcase(@RequestParam String cmd) {
        Map<String, Object> modelMap = new HashMap<>();
        try {
            String[] strs = Invoke.generateMutableArray("a", "b", "c", "d", "e");
