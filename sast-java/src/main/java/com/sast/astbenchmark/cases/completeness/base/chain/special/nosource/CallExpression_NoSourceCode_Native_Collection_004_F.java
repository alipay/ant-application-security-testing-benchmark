...
// compose = CallExpression_NoSourceCode_Native_Collection_003_T.java && !CallExpression_NoSourceCode_Native_Collection_004_F.java
// bind_url = completeness/base/chain/special/nosource/CallExpression_NoSourceCode_Native_Collection_004_F
// assession information end

@RestController()
@RequestMapping("completeness/base/chain/special/nosource")
public class CallExpression_NoSourceCode_Native_Collection_004_F {
    @PostMapping(value = "CallExpression_NoSourceCode_Native_Collection_004_F")
