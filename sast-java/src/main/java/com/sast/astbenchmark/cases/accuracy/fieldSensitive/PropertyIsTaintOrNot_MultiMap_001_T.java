...
// bind_url = completeness/base/chain/astTaint/PropertyIsTaintOrNot_MultiMap_001_T
// assession information end

@RestController()
@RequestMapping("accuracy/fieldSensitive/propertyIsTaintOrNot")
public class PropertyIsTaintOrNot_MultiMap_001_T {
    @PostMapping(value = "PropertyIsTaintOrNot_MultiMap_001_T")
