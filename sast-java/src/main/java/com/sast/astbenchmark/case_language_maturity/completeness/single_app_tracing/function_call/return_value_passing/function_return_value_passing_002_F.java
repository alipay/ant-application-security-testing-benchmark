...
// level = 2
// bind_url = completeness/single_app_tracing/function_call/return_value_passing/function_return_value_passing_002_F
// evaluation information end
@RestController()
@RequestMapping("completeness/single_app_tracing/function_call/return_value_passing")
public class function_return_value_passing_002_F {
    @PostMapping(value = "function_return_value_passing_002_F")
