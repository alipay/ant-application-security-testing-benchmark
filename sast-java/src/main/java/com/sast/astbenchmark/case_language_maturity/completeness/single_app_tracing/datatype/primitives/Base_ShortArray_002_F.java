...
// level = 2
// bind_url = completeness/single_app_tracing/datatype/primitives/Base_ShortArray_002_F
// date = 2025-12-05 17:22:10
// evaluation information end

@RestController()
@RequestMapping("completeness/single_app_tracing/datatype/primitives")
public class Base_ShortArray_002_F {
  @PostMapping("Base_ShortArray_002_F")
  public Map<String, Object> base_shortarray_002_f(@RequestBody short[] cmd) {
    Map<String, Object> modelMap = new HashMap<>();
    if (cmd == null || cmd.length < 1) {
      modelMap.put("status", "error");
      return modelMap;
    }
    // 场景特点：short数组类型传递但使用固定值
