...
// level = 4
// bind_url = accuracy/path_sensitive/loop_conditional_stmt/solver/Statement_AssertStatement_solver_003_T/{cmd}
// evaluation information end
@RestController()
@RequestMapping("accuracy/path_sensitive/loop_conditional_stmt/solver")
public class Statement_AssertStatement_solver_003_T {
    @GetMapping("Statement_AssertStatement_solver_003_T/{cmd}")
