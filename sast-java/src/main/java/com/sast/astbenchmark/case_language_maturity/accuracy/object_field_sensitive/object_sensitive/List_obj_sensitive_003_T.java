...
// level = 2
// bind_url = accuracy/object_field_sensitive/object_sensitive/List_obj_sensitive_003_T
// date = 2025-12-10 18:20:00
// evaluation information end

@RestController
@RequestMapping("accuracy/object_field_sensitive/object_sensitive")
public class List_obj_sensitive_003_T {
  @GetMapping("List_obj_sensitive_003_T/{cmd}")
  public Map<String, Object> list_obj_sensitive_003_t(@PathVariable String cmd) {
