...
// level = 2
// bind_url = completeness/single_app_tracing/expression/type_cast/Expression_CastExpression_009_T
// date = 2025-12-09 11:31:00
// evaluation information end

@RestController()
@RequestMapping("completeness/single_app_tracing/expression/type_cast")
public class Expression_CastExpression_009_T {

  @GetMapping("Expression_CastExpression_009_T/{cmd}")
  public Map<String, Object> expression_castexpression_009_t(@PathVariable String cmd) {
