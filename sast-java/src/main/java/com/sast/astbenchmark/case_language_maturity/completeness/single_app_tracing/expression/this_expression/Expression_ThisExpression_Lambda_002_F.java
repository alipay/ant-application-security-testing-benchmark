...
/**
 * Introduction 完整度->单应用跟踪完整度->表达式->this表达式+lambda表达式
 * Level 2
 * Date 2024-05-09
 */
// evaluation information start
// real case = false
// evaluation item = 完整度->单应用跟踪完整度->表达式->this表达式+lambda表达式
// bind_url = completeness/single_app_tracing/expression/this_expression/Expression_ThisExpression_Lambda_002_F/{url}
// evaluation information end

@RestController()
@RequestMapping("completeness/single_app_tracing/expression/this_expression")
public class Expression_ThisExpression_Lambda_002_F {
    private SSRFShowManager ssrfShowManager = new SSRFShowManageImpl();

    @GetMapping("Expression_ThisExpression_Lambda_002_F/{url}")
