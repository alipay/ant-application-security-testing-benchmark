...
// level = 2
// bind_url = accuracy/context_sensitive/argument_return_value_passing/Method_Overloading_001_T
// date = 2025-12-10 15:15:00
// evaluation information end
@RestController()
@RequestMapping("accuracy/context_sensitive/argument_return_value_passing")
public class Method_Overloading_001_T {
  @GetMapping("Method_Overloading_001_T/{cmd}")
  public Map<String, Object> method_overloading_001_t(@PathVariable String cmd) {
