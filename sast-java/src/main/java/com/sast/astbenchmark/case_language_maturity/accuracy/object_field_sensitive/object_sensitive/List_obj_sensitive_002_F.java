...
// level = 2
// bind_url = accuracy/object_field_sensitive/object_sensitive/List_obj_sensitive_002_F
// date = 2025-12-10 18:20:00
// evaluation information end

@RestController
@RequestMapping("accuracy/object_field_sensitive/object_sensitive")
public class List_obj_sensitive_002_F {
  @GetMapping("List_obj_sensitive_002_F/{cmd}")
  public Map<String, Object> list_obj_sensitive_002_f(@PathVariable String cmd) {
