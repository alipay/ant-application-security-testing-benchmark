...
// level = 2
// bind_url = completeness/single_app_tracing/datatype/primitives/Base_Char_004_F
// evaluation information end

@RestController()
@RequestMapping("completeness/single_app_tracing/datatype/primitives")
public class Base_Char_004_F {
    @PostMapping("Base_Char_004_F/{cmd}")
    public Map<String, Object> aTaintCase0148(@PathVariable Character cmd) {
        Map<String, Object> modelMap = new HashMap<>();
        Character ch = 'a';
        Runtime.getRuntime().exec(ch);
