...
// level = 3
// bind_url = accuracy/object_field_sensitive/field_sensitive_one_collection/numeric_index_state_no_solver/MapField_008_F
...
public class MapField_008_F {
    ...
    public Map<String, Object> testcase(@RequestParam String cmd) {
        ...
        try {
            ...
            map.put("key1", "_");
            Runtime.getRuntime().exec(map.entrySet().toString());
        } catch (Exception e) {
