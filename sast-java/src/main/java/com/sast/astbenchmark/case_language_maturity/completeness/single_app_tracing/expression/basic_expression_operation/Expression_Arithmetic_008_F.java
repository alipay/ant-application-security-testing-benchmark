...
// level = 2
// bind_url = completeness/single_app_tracing/expression/basic_expression_operation/Expression_Arithmetic_008_F
// date = 2025-12-08 18:39:00
// evaluation information end

@RestController()
@RequestMapping("completeness/single_app_tracing/expression/basic_expression_operation")
public class Expression_Arithmetic_008_F {
  @GetMapping("Expression_Arithmetic_008_F/{cmd}")
  public Map<String, Object> expression_arithmetic_008_f(@PathVariable int cmd) {
