...
// level = 4
// bind_url = accuracy/flow_sensitive/asynchronous/CompletableFuture_asynchronous_001_T
// evaluation information end
@RestController
@RequestMapping("accuracy/flow_sensitive/asynchronous")
public class CompletableFuture_asynchronous_001_T {
    @PostMapping(value = "CompletableFuture_asynchronous_001_T")
