...
// scene introduction = 向下转型-子类引用
// level = 2
// bind_url = completeness/single_app_tracing/expression/type_cast/Expression_CastExpression_010_F
// date = 2025-12-09 11:31:00
// evaluation information end

@RestController()
@RequestMapping("completeness/single_app_tracing/expression/type_cast")
public class Expression_CastExpression_010_F {

  @GetMapping("Expression_CastExpression_010_F/{cmd}")
  public Map<String, Object> expression_castexpression_010_f(@PathVariable String cmd) {
    Map<String, Object> modelMap = new HashMap<>();
    try {
      // 场景特点：父类引用向下转型为子类引用但输入输出不一致
      AC abs = new AC();
      AC ac = (AC) abs;
      ac.setCmd(cmd);
