...
// level = 2
// bind_url = completeness/single_app_tracing/interface_class/abstract_class/CallExpression_CustomCode_abstract_class_002_F
// evaluation information end
@RestController()
@RequestMapping("completeness/single_app_tracing/interface_class/abstract_class")
public class CallExpression_CustomCode_abstract_class_002_F {
    @GetMapping("CallExpression_CustomCode_abstract_class_002_F")
