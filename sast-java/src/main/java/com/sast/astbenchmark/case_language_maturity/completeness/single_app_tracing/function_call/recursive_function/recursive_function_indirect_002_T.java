...
// bind_url = completeness/single_app_tracing/function_call/recursive_function/recursive_function_indirect_002_T
// evaluation information end
@RestController()
@RequestMapping("completeness/single_app_tracing/function_call/recursive_function")
public class recursive_function_indirect_002_T {
    @PostMapping(value = "recursive_function_indirect_002_T")
    public static void recursive_function_indirect_002_T(@RequestParam Object __taint_src) {
