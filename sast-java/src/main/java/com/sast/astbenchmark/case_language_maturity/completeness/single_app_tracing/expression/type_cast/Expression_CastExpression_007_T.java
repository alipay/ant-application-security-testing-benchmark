...
public class Expression_CastExpression_007_T {

  @GetMapping("Expression_CastExpression_007_T/{cmd}")
  public Map<String, Object> expression_castexpression_007_t(@PathVariable String cmd) {
    Map<String, Object> modelMap = new HashMap<>();
    try {
      // 场景特点：子类对象向上转型为父类引用
      ABS abs = new AC();
      abs.setCmd(cmd);
      SinkUtil.sink(abs.getCmd());
