...
// level = 2
// bind_url = completeness/single_app_tracing/datatype/primitives/Base_Boolean_003_T
// date = 2025-12-05 17:22:10
// evaluation information end

@RestController()
@RequestMapping("completeness/single_app_tracing/datatype/primitives")
public class Base_Boolean_003_T {
  @PostMapping("Base_Boolean_003_T")
  public Map<String, Object> base_boolean_003_t(@RequestBody Boolean cmd) {
