...
// scene introduction = Set1
// level = 2
// bind_url = completeness/single_app_tracing/datatype/collections/Base_Set_002_F
// evaluation information end

@RestController()
@RequestMapping("completeness/single_app_tracing/datatype/collections")
public class Base_Set_002_F {
  @PostMapping("Base_Set_002_F")
  public Map<String, Object> aTaintCase0143(@RequestBody List<String> cmd) {
    Map<String, Object> modelMap = new HashMap<>();
    List<String> list = Arrays.asList("a", "b", "c");
    Set<String> stringSet = new HashSet<>(list);
    try {
      Runtime.getRuntime().exec(stringSet.toString());
