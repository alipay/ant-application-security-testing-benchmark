...
/**
 * Introduction 完整度->单应用跟踪完整度->表达式->this表达式
 * Level 2
 * Date 2024-05-09
 */
...
// bind_url = completeness/single_app_tracing/expression/this_expression/Expression_ThisExpression_001_T/{url}
...
public class Expression_ThisExpression_001_T {
    ...
    @GetMapping("Expression_ThisExpression_001_T/{url}")
