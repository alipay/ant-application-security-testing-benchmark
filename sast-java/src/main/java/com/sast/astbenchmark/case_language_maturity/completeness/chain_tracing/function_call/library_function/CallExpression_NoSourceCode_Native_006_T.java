...
// assession project = 完整度->基础跟踪能力->污点链路完整度->特殊场景->无源码函数调用->string.getBytes
// compose = CallExpression_NoSourceCode_Native_006_T.java
// bind_url = completeness/base/chain/special/nosource/CallExpression_NoSourceCode_Native_006_T
// assession information end

@RestController()
@RequestMapping("completeness/base/chain/special/nosource")
public class CallExpression_NoSourceCode_Native_006_T {
    @PostMapping(value = "CallExpression_NoSourceCode_Native_006_T")
