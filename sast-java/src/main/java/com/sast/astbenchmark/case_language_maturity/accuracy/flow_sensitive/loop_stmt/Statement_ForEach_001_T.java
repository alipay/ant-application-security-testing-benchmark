...
// level = 2
// bind_url = accuracy/flow_sensitive/loop_stmt/Statement_ForEach_001_T
// date = 2025-12-10 14:15:00
// evaluation information end

@RestController()
@RequestMapping("accuracy/flow_sensitive/loop_stmt")
public class Statement_ForEach_001_T {
  @PostMapping("Statement_ForEach_001_T")
  public Map<String, Object> statement_foreach_001_T(@RequestBody String[] cmd) {
