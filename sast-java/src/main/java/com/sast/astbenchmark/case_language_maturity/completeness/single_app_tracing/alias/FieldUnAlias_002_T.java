...
// real case = true
// evaluation item = 完整度->链路跟踪完整度->引用和指针->别名->对象属性->对象指针->FieldUnAlias-scene1
// bind_url = completeness/single_app_tracing/references_pointers/alias/FieldUnAlias_002_T
