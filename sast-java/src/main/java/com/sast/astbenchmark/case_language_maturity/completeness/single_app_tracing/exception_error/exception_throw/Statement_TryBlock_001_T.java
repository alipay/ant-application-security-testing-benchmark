...
// level = 2+
// bind_url = completeness/single_app_tracing/exception_error/exception_throw/Statement_TryBlock_001_T/{cmd}
// evaluation information end
@RestController
@RequestMapping("completeness/single_app_tracing/exception_error/exception_throw")
public class Statement_TryBlock_001_T {
    @GetMapping("Statement_TryBlock_001_T/{cmd}")
