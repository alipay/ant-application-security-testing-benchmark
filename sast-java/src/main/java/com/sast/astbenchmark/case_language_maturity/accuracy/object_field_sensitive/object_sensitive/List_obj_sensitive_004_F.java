...
// scene introduction = List-set
// level = 2
// bind_url = accuracy/object_field_sensitive/object_sensitive/List_obj_sensitive_004_F
// date = 2025-12-10 18:25:00
// evaluation information end

@RestController
@RequestMapping("accuracy/object_field_sensitive/object_sensitive")
public class List_obj_sensitive_004_F {
  @GetMapping("List_obj_sensitive_004_F/{cmd}")
  public Map<String, Object> list_obj_sensitive_004_f(@PathVariable String cmd) {
    Map<String, Object> modelMap = new HashMap<>();
    try {
      // 场景特点：List设置操作，但使用固定安全值，输入与输出不一致
