...
// real case = true
// evaluation item = 完整度->链路跟踪完整度->表达式->基础表达式->前缀表达式
// bind_url = completeness/single_app_tracing/expression/basic_expression_operation/Expression_PrefixExpression_001_T/{cmd}
