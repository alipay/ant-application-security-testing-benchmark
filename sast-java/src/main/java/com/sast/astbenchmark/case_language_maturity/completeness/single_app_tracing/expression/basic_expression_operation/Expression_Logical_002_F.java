...
// level = 2
// bind_url = completeness/single_app_tracing/expression/basic_expression_operation/Expression_Logical_002_F
// date = 2025-12-08 18:45:00
// evaluation information end

@RestController()
@RequestMapping("completeness/single_app_tracing/expression/basic_expression_operation")
public class Expression_Logical_002_F {
  @GetMapping("Expression_Logical_002_F/{cmd}")
  public Map<String, Object> expression_logical_002_f(@PathVariable boolean cmd) {
