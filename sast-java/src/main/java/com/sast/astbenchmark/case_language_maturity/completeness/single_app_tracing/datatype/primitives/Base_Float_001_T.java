...
// real case = true
// evaluation item = 完整度->基础跟踪能力->污点对象完整度->java原生对象->float
// bind_url = completeness/base/object/javaNative/Base_Float_001_T/{cmd}
// evaluation information end

@RestController()
@RequestMapping("completeness/base/object/javaNative")
public class Base_Float_001_T {
    @GetMapping("Base_Float_001_T/{cmd}")
