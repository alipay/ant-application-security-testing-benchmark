...
// level = 2
// bind_url = completeness/single_app_tracing/expression/basic_expression_operation/Expression_Logical_006_F
// date = 2025-12-08 18:45:00
// evaluation information end

@RestController()
@RequestMapping("completeness/single_app_tracing/expression/basic_expression_operation")
public class Expression_Logical_006_F {
  @GetMapping("Expression_Logical_006_F/{cmd}")
  public Map<String, Object> expression_logical_006_f(@PathVariable boolean cmd) {
    Map<String, Object> modelMap = new HashMap<>();
    try {
      // 场景特点：非运算后结果被固定值覆盖，输入与输出不一致
      boolean result = !cmd;
      result = true;
