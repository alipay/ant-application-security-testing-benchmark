...
// level = 4+
// bind_url = accuracy/path_sensitive/explicit_jump_control/Statement_InterruptStatement_009_T
// date = 2025-12-11 11:37:30
// evaluation information end
@RestController
@RequestMapping("accuracy/path_sensitive/explicit_jump_control")
public class Statement_InterruptStatement_009_T {
  @GetMapping("Statement_InterruptStatement_009_T/{cmd}")
  public Map<String, Object> statement_interruptstatement_009_t(@PathVariable String cmd) {
