...
// level = 2
// bind_url = completeness/single_app_tracing/expression/type_cast/Expression_CastExpression_006_F
// date = 2025-12-09 11:21:00
// evaluation information end

@RestController()
@RequestMapping("completeness/single_app_tracing/expression/type_cast")
public class Expression_CastExpression_006_F {

  @GetMapping("Expression_CastExpression_006_F/{cmd}")
  public Map<String, Object> expression_castexpression_006_f(@PathVariable String cmd) {
    Map<String, Object> modelMap = new HashMap<>();
    try {
      // 场景特点：接口转型实现类对象但输入输出不一致
      Object command = "clean";
