...
// level = 2
// bind_url = completeness/single_app_tracing/expression/basic_expression_operation/Expression_Comparison_001_T
// date = 2025-12-08 19:04:00
// evaluation information end

@RestController()
@RequestMapping("completeness/single_app_tracing/expression/basic_expression_operation")
public class Expression_Comparison_001_T {
  @GetMapping("Expression_Comparison_001_T/{cmd}")
  public Map<String, Object> expression_comparison_001_t(@PathVariable int cmd) {
