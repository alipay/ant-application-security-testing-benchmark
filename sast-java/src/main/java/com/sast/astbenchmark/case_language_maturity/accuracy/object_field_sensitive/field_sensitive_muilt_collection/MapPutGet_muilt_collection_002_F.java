...
// scene introduction = MapPutGet
// level = 4
// bind_url = accuracy/object_field_sensitive/field_sensitive_muilt_collection/MapPutGet_muilt_collection_002_F
// evaluation information end

@RestController()
@RequestMapping("accuracy/object_field_sensitive/field_sensitive/map")
public class MapPutGet_muilt_collection_002_F {
    @PostMapping(value = "MapPutGet_muilt_collection_002_F")
