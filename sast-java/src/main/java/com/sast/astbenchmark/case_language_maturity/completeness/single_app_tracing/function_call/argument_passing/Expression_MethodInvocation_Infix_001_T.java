...
// level = 2
// bind_url = completeness/single_app_tracing/function_call/argument_passing/Expression_MethodInvocation_Infix_001_T/{cmd}
// evaluation information end
@RestController()
@RequestMapping("completeness/single_app_tracing/function_call/argument_passing")
public class Expression_MethodInvocation_Infix_001_T {
    @GetMapping("Expression_MethodInvocation_Infix_001_T/{cmd}")
