...
// level = 3
// bind_url = accuracy/path_sensitive/loop_conditional_stmt/no_solver/While_No_Solver_001_T
// date = 2025-12-11 11:02:30
// evaluation information end
@RestController
@RequestMapping("accuracy/path_sensitive/loop_conditional_stmt/no_solver")
public class While_No_Solver_001_T {
  @GetMapping("While_No_Solver_001_T/{cmd}")
  public Map<String, Object> while_no_solver_001_t(@PathVariable String cmd) {
