...
// level = 2
// bind_url = accuracy/object_field_sensitive/object_sensitive/Queue_obj_sensitive_003_T
// date = 2025-12-10 18:45:00
// evaluation information end

@RestController
@RequestMapping("accuracy/object_field_sensitive/object_sensitive")
public class Queue_obj_sensitive_003_T {
  @GetMapping("Queue_obj_sensitive_003_T/{cmd}")
  public Map<String, Object> queue_obj_sensitive_003_t(@PathVariable String cmd) {
