...
// scene introduction = assert语句-条件不成立
// level = 4
// bind_url = accuracy/path_sensitive/loop_conditional_stmt/solver/Statement_AssertStatement_solver_004_F/{cmd}
// evaluation information end
@RestController()
@RequestMapping("accuracy/path_sensitive/loop_conditional_stmt/solver")
public class Statement_AssertStatement_solver_004_F {
    @GetMapping("Statement_AssertStatement_solver_004_F/{cmd}")
