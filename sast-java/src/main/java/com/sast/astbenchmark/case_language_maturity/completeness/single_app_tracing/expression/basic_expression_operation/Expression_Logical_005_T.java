...
public class Expression_Logical_005_T {
    @GetMapping("Expression_Logical_005_T/{cmd}")
    public Map<String, Object> expression_logical_005_t(@PathVariable boolean cmd) {
