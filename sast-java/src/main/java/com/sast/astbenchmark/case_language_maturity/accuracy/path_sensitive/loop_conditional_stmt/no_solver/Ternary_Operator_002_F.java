...
// level = 3
// bind_url = accuracy/path_sensitive/loop_conditional_stmt/no_solver/Ternary_Operator_002_F
// date = 2025-12-11 11:03:00
// evaluation information end
@RestController
@RequestMapping("accuracy/path_sensitive/loop_conditional_stmt/no_solver")
public class Ternary_Operator_002_F {
  @GetMapping("Ternary_Operator_002_F/{cmd}")
  public Map<String, Object> ternary_operator_002_f(@PathVariable String cmd) {
    Map<String, Object> modelMap = new HashMap<>();
    try {
      // 场景特点：三目运算符条件为常量false，执行false分支
      String result = false ? cmd : "safe_value";
