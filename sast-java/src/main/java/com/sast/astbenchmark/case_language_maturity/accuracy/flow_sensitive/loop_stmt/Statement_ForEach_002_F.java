...
// level = 2
// bind_url = accuracy/flow_sensitive/loop_stmt/Statement_ForEach_002_F
// date = 2025-12-10 14:15:00
// evaluation information end
@RestController()
@RequestMapping("accuracy/flow_sensitive/loop_stmt")
public class Statement_ForEach_002_F {
  @PostMapping("Statement_ForEach_002_F")
  public Map<String, Object> statement_foreach_002_f(@RequestBody String[] cmd) {
