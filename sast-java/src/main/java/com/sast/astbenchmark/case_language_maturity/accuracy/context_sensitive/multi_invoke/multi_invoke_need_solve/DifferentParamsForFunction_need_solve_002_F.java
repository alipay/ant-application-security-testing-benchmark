...
// level = 4
// bind_url = accuracy/context_sensitive/multi_invoke/multi_invoke_need_solve/DifferentParamsForFunction_need_solve_002_F
// evaluation information end

@RestController
@RequestMapping("accuracy/context_sensitive/multi_invoke/multi_invoke_need_solve")
public class DifferentParamsForFunction_need_solve_002_F {
    @PostMapping(value = "DifferentParamsForFunction_need_solve_002_F")
