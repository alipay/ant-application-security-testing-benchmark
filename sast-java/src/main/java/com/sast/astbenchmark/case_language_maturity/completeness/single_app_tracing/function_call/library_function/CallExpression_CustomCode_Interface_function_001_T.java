...
// level = 2+
// bind_url = completeness/single_app_tracing/function_call/library_function/CallExpression_CustomCode_Interface_function_001_T
// evaluation information end
@RestController()
@RequestMapping("completeness/single_app_tracing/function_call/library_function")
public class CallExpression_CustomCode_Interface_function_001_T {
    @PostMapping(value = "CallExpression_CustomCode_Interface_function_001_T")
