...
// scene introduction = do-while
// level = 3
// bind_url = accuracy/path_sensitive/loop_conditional_stmt/no_solver/Do_While_002_F
// date = 2025-12-11 11:02:45
// evaluation information end
@RestController
@RequestMapping("accuracy/path_sensitive/loop_conditional_stmt/no_solver")
public class Do_While_002_F {
  @GetMapping("Do_While_002_F/{cmd}")
  public Map<String, Object> do_while_002_f(@PathVariable String cmd) {
