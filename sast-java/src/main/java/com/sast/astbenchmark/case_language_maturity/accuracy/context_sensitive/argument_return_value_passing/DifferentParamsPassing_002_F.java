...
// level = 2
// bind_url = accuracy/context_sensitive/argument_return_value_passing/DifferentParamsPassing_002_F
// evaluation information end

@RestController()
@RequestMapping("accuracy/context_sensitive/argument_return_value_passing")
public class DifferentParamsPassing_002_F {
    @PostMapping("DifferentParamsPassing_002_F")
