...
// level = 2
// bind_url = completeness/single_app_tracing/function_call/argument_passing/Argument_Passing_001_T
// date = 2025-12-09 14:12:00
// evaluation information end
@RestController()
@RequestMapping("completeness/single_app_tracing/function_call/argument_passing")
public class Argument_Passing_001_T {
  @GetMapping("Argument_Passing_001_T/{cmd}")
  public Map<String, Object> argument_passing_001_t(@PathVariable String cmd) {
