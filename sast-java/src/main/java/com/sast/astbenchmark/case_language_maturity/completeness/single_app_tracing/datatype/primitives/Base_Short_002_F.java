...
// level = 2
// bind_url = completeness/single_app_tracing/datatype/primitives/Base_Short_002_F
// date = 2025-12-05 17:22:10
// evaluation information end

@RestController()
@RequestMapping("completeness/single_app_tracing/datatype/primitives")
public class Base_Short_002_F {
  @GetMapping("Base_Short_002_F/{cmd}")
  public Map<String, Object> base_short_002_f(@PathVariable short cmd) {
    Map<String, Object> modelMap = new HashMap<>();
    // 场景特点：基本短整型变量传递但使用固定值
    short s = 0;
    try {
