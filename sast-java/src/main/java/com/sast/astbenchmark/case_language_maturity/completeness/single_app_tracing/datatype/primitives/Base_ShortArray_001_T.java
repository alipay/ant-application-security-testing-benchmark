...
// level = 2
// bind_url = completeness/single_app_tracing/datatype/primitives/Base_ShortArray_001_T
// date = 2025-12-05 17:22:10
// evaluation information end

@RestController()
@RequestMapping("completeness/single_app_tracing/datatype/primitives")
public class Base_ShortArray_001_T {
  @PostMapping("Base_ShortArray_001_T")
  public Map<String, Object> base_shortarray_001_t(@RequestBody short[] cmd) {
