...
// level = 4
// bind_url = accuracy/path_sensitive/loop_conditional_stmt/solver/Statement_WhileStatement_solver_002_F/{type}/{cmd}
// evaluation information end
@RestController()
@RequestMapping("accuracy/path_sensitive/loop_conditional_stmt/solver")
public class Statement_WhileStatement_solver_002_F {
    @GetMapping("Statement_WhileStatement_solver_002_F/{type}/{cmd}")
