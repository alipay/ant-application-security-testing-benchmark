...
// level = 4
// bind_url = accuracy/path_sensitive/loop_conditional_stmt/solver/Statement_WhileStatement_solver_002_F
...
public class Statement_WhileStatement_solver_002_F {
    @GetMapping("Statement_WhileStatement_solver_002_F/{cmd}")
