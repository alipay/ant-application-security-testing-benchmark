...
// real case = true
// evaluation project = 完整度->单应用跟踪完整度->并发、多线程、异步->同步原语
// bind_url = completeness/single_app_tracing/asynchronous_tracing/promise_callback_await/CompletableFuture_004_F/{cmd}
