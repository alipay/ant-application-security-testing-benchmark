...
// level = 2
// bind_url = accuracy/object_field_sensitive/object_sensitive/List_obj_sensitive_006_F
// date = 2025-12-10 18:25:00
// evaluation information end

@RestController
@RequestMapping("accuracy/object_field_sensitive/object_sensitive")
public class List_obj_sensitive_006_F {
  @GetMapping("List_obj_sensitive_006_F/{cmd}")
  public Map<String, Object> list_obj_sensitive_006_f(@PathVariable String cmd) {
    Map<String, Object> modelMap = new HashMap<>();
    try {
      // 场景特点：List移除操作，但使用固定安全值，输入与输出不一致
