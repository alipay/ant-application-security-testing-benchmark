...
// level = 3
// bind_url = accuracy/object_field_sensitive/field_sensitive_one_collection/numeric_index_state_no_solver/MapField_005_T
...
public class MapField_005_T {
    ...
    public Map<String, Object> testcase(@RequestParam String cmd) {
        ...
        try {
            ...
            map.put(cmd, "value1");
            Runtime.getRuntime().exec(map.keySet().toString());
        } catch (Exception e) {
