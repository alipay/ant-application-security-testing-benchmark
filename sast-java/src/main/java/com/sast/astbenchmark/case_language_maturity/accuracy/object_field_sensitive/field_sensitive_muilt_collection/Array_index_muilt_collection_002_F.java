...
// level = 4
// bind_url = accuracy/object_field_sensitive/field_sensitive_muilt_collection/Array_index_muilt_collection_002_F
// evaluation information end
@RestController()
@RequestMapping("accuracy/object_field_sensitive/field_sensitive_muilt_collection")
public class Array_index_muilt_collection_002_F {
    @PostMapping("Array_index_muilt_collection_002_F")
