...
// real case = true
// evaluation item = 完整度->基础跟踪能力->污点链路完整度->ast对象->this表达式+lambda表达式
// bind_url = completeness/chain_tracing/expression/this_expression/Expression_ThisExpression_Lambda_001_T
