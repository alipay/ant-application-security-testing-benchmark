...
// assession project = 完整度->基础跟踪能力->污点链路完整度->ast对象->this表达式+lambda表达式
// compose = Expression_ThisExpression_Lambda_001_T.java
// bind_url = completeness/base/chain/astTaint/Expression_ThisExpression_Lambda_001_T/{url}
