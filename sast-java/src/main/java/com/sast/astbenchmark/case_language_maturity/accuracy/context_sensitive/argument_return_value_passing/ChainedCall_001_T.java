...
// level = 2
// bind_url = accuracy/context_sensitive/argument_return_value_passing/ChainedCall_001_T
// date = 2025-12-10 15:15:00
// evaluation information end
@RestController()
@RequestMapping("accuracy/context_sensitive/argument_return_value_passing")
public class ChainedCall_001_T {
  @PostMapping("ChainedCall_001_T")
  public Map<String, Object> chainedcall_001_t(@RequestParam String cmd) {
