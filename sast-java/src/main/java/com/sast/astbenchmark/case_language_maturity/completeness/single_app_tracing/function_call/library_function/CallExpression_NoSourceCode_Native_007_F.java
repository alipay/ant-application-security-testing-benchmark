...
/**
 * Introduction 污点链路样本中的特殊场景-无源码函数-string copyValueOf
 * Level 2
 * Date 2024-05-09
 */
...
// bind_url = completeness/single_app_tracing/function_call/library_function/CallExpression_NoSourceCode_Native_007_F
// evaluation information end
@RestController()
@RequestMapping("completeness/single_app_tracing/function_call/library_function")
public class CallExpression_NoSourceCode_Native_007_F {
    @PostMapping(value = "CallExpression_NoSourceCode_Native_007_F")
    public Map<String, Object> aTaintCase0162(@RequestParam String cmd) {
        Map<String, Object> modelMap = new HashMap<>();
        try {
            char data[] =  "ls".toCharArray();
