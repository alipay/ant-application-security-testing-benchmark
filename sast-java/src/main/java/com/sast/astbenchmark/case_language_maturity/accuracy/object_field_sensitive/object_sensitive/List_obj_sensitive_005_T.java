...
// level = 2
// bind_url = accuracy/object_field_sensitive/object_sensitive/List_obj_sensitive_005_T
// date = 2025-12-10 18:25:00
// evaluation information end

@RestController
@RequestMapping("accuracy/object_field_sensitive/object_sensitive")
public class List_obj_sensitive_005_T {
  @GetMapping("List_obj_sensitive_005_T/{cmd}")
  public Map<String, Object> list_obj_sensitive_005_t(@PathVariable String cmd) {
    Map<String, Object> modelMap = new HashMap<>();
    try {
      // 场景特点：List移除操作，先添加再移除其他元素，保留污点数据
      List<String> list = new ArrayList<>();
      list.add(cmd);
      list.add("safe_value");
      list.remove(1); // 移除安全值，保留污点
